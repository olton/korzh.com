...
import claim01Image from "./anc22-add-extra-claim01.png"
import claim02Image from "./anc22-add-extra-claim02.png"
import claim03Image from "./anc22-add-extra-claim03.png"

This is a second edition of the [previous post on the same topic](/blog/aspnet-identity-store-user-data-in-claims).
...
Moreover, it became even easier because of some changes in version 2.2 of ASP.NET Core (in comparison with version 2.0 as [we described before](/blog/add-extra-user-claims-aspnet-core-webapp) )
