...
import ancIdentityNewAppImage from "./anc-identity-newapp01.png"
import ancIdentityRegistrationImage from "./anc-identity-registration.png"
import ancIdentityContactImage from "./anc-identity-contact-name.png"
...
<Image src={ancIdentityNewAppImage} alt=""/>
...
<Image src={ancIdentityRegistrationImage} alt="Registration form with ContactName field"/>
...
<Image class="mt-4" src={ancIdentityContactImage} alt="ASP.NET Core - renderring contact name instead of user's ID"/>
